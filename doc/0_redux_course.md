...
# 目录
- [目录](#目录)
- [01. The Single Immutable State Tree](#01-the-single-immutable-state-tree)
- [02. Describing State Changes with Actions](#02-describing-state-changes-with-actions)
- [03. Pure and Impure Functions](#03-pure-and-impure-functions)
- [04. The Reducer Function](#04-the-reducer-function)
- [05. Writing a Counter Reducer with Tests](#05-writing-a-counter-reducer-with-tests)
- [06. Store Methods: `getState()`, `dispatch()`, and `subscribe()`](#06-store-methods-getstate-dispatch-and-subscribe)
      - [`store` has 3 important methods:](#store-has-3-important-methods)
- [07. Implementing Store from Scratch](#07-implementing-store-from-scratch)
- [08. React Counter Example](#08-react-counter-example)
      - [To recap how it works...](#to-recap-how-it-works)
- [09. Avoiding Array Mutations](#09-avoiding-array-mutations)
- [10. Avoiding Object Mutations with `Object.assign()` and `...spread`](#10-avoiding-object-mutations-with-objectassign-and-spread)
- [11. Writing a Todo List Reducer (Adding a Todo)](#11-writing-a-todo-list-reducer-adding-a-todo)
      - [Data Flow:](#data-flow)
- [12. Writing a Todo List Reducer (Toggling a Todo)](#12-writing-a-todo-list-reducer-toggling-a-todo)
- [13. Reducer Composition with Arrays](#13-reducer-composition-with-arrays)
- [14. Reducer Composition with Objects](#14-reducer-composition-with-objects)
- [15.Reducer Composition with `combineReducers()`](#15reducer-composition-with-combinereducers)
- [16. Implementing `combineReducers()` from Scratch](#16-implementing-combinereducers-from-scratch)
- [17. React Todo List Example (Adding a Todo)](#17-react-todo-list-example-adding-a-todo)
    - [Now that all that code is written...](#now-that-all-that-code-is-written)
      - [Recap of how the application works:](#recap-of-how-the-application-works)
      - [Recap of how mutations work in Redux:](#recap-of-how-mutations-work-in-redux)
- [18. React Todo List Example (Toggling a Todo)](#18-react-todo-list-example-toggling-a-todo)
      - [Recap of how toggling a todo item works](#recap-of-how-toggling-a-todo-item-works)
- [19. React Todo List Example (Filtering Todos)](#19-react-todo-list-example-filtering-todos)
      - [To review how changing a visibility filter works...](#to-review-how-changing-a-visibility-filter-works)
- [20. Extracting Presentational Components (Todo, Todolist)](#20-extracting-presentational-components-todo-todolist)
        - [Current `TodoApp` Component Code:](#current-todoapp-component-code)
      - [Refactoring for a Single Todo Item](#refactoring-for-a-single-todo-item)
      - [Refactoring for the Todo List](#refactoring-for-the-todo-list)
      - [Container Components (`TodoApp`)](#container-components-todoapp)
      - [To Recap...](#to-recap)
- [21. Extracting Presentational Components (AddTodo, Footer, FilterLink)](#21-extracting-presentational-components-addtodo-footer-filterlink)
      - [Current `TodoApp` Code:](#current-todoapp-code)
      - [Extracting the Input and the Button into `AddTodo`](#extracting-the-input-and-the-button-into-addtodo)
      - [Extracting the `FilterLink` Footer Elements](#extracting-the-filterlink-footer-elements)
      - [Adding `Footer` to `TodoApp`](#adding-footer-to-todoapp)
      - [Changing `TodoApp` into a function](#changing-todoapp-into-a-function)
      - [Recap of the Data Flow](#recap-of-the-data-flow)
- [22. Extracting Container Components (FilterLink)](#22-extracting-container-components-filterlink)
      - [Extracting the `Footer` Component](#extracting-the-footer-component)
      - [Refactoring `FilterLink`](#refactoring-filterlink)
      - [The New `FilterLink`](#the-new-filterlink)
      - [Problems with `FilterLink`](#problems-with-filterlink)
      - [Recap](#recap)
- [23. Extracting Container Components (VisibleTodoList, AddTodo)](#23-extracting-container-components-visibletodolist-addtodo)
      - [Changing `AddTodo` to a Container](#changing-addtodo-to-a-container)
      - [Refactored `TodoApp`](#refactored-todoapp)
      - [Recap of Data Flow](#recap-of-data-flow)
- [24. Passing the Store Down Explicitly via Props](#24-passing-the-store-down-explicitly-via-props)
          - [Before:](#before)
        - [After:](#after)
      - [Refactoring `TodoApp` to accept `store`](#refactoring-todoapp-to-accept-store)
- [25. Passing the Store Down Implicitly via Context](#25-passing-the-store-down-implicitly-via-context)
      - [Refactor Components to get `store` from `context` instead of `props`](#refactor-components-to-get-store-from-context-instead-of-props)
      - [Updating our Functional Components for `context`](#updating-our-functional-components-for-context)
        - [Updating `FilterLink`](#updating-filterlink)
      - [Recap](#recap-1)
- [26. Passing the Store Down with `<Provider>` from React Redux](#26-passing-the-store-down-with-provider-from-react-redux)
- [27. Generating Containers with `connect()` from React Redux (`VisibleTodoList`)](#27-generating-containers-with-connect-from-react-redux-visibletodolist)
        - [Review of what we just did...](#review-of-what-we-just-did)
        - [The `connect()` function](#the-connect-function)
- [28. Generating Containers with `connect()` from React Redux (AddTodo)](#28-generating-containers-with-connect-from-react-redux-addtodo)
        - [Before:](#before-1)
        - [After:](#after-1)
      - [But it's wasteful...](#but-its-wasteful)
- [29. Generating Containers with `connect()` from React Redux (`FooterLink`)](#29-generating-containers-with-connect-from-react-redux-footerlink)
      - [`mapStateToProps`](#mapstatetoprops)
      - [`mapDispatchToProps`](#mapdispatchtoprops)
      - [`connect()` it Up](#connect-it-up)
- [30. Extracting Action Creators](#30-extracting-action-creators)
        - [Existing `AddTodo` Code](#existing-addtodo-code)
      - [Action Creator](#action-creator)
      - [`'SET_VISIBILITY_FILTER'` inside of `mapDispatchToLinkProps`:](#set_visibility_filter-inside-of-mapdispatchtolinkprops)
      - [`'TOGGLE_TODO'` inside of `mapDispatchToTodoListProps`:](#toggle_todo-inside-of-mapdispatchtotodolistprops)
      - [Recap](#recap-2)
